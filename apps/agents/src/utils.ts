...
export const formatReflections = (
  ...
  let assistantRoleArr = reflections.assistantRole;
  let assistantRoleStr = "No assistant role assumptions found.";
  if (!Array.isArray(assistantRoleArr)) {
    try {
      assistantRoleArr = JSON.parse(assistantRoleArr);
      assistantRoleStr = assistantRoleArr.join("\n- ");
    } catch (_) {
      console.error(
        "FAILED TO PARSE ASSISTANT ROLE. \n\ntypeof:",
        typeof assistantRoleArr,
        "\n\nassistantRole:",
        assistantRoleArr
      );
    }
...
- ${contentRulesStr}
  ...
  const assistantRoleString = `The following is a list of assumptions about the user's role/objectives previously generated by you:
<assistant-role>
- ${assistantRoleStr}
</assistant-role>`;
